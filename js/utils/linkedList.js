...
class LinkedList{
    ...
    push(...values){
        for(let i of values) {
            ...
            else if(this.last)this.last.next = item;
            this.last = item;
        }
    }
    pushForward(...values){
    ...
    *iteratorBackwards(){
    ...
    _normalizeIndex(index,_i=undefined){
...
LinkedList.CALLBACK_REMOVE = 1;
LinkedList.CALLBACK_BREAK = 2;
LinkedList.CALLBACK_REPLACE_WITH = 4;
